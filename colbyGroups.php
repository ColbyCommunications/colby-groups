...
define('LOCATION_401', '401_wp.php');
define('LOCATION_403', '403.html');
define('LOCATION_404', 'search.html');
define('CCG_DEBUG',  0);
...
if (defined('CCG_FOLDER') ) {
    include_once dirname(__FILE__).'/lib/ccg_bootstrap_lib.php';
    ...
    function _ccg_act_load()
    {
        ...
        include_once dirname(__FILE__).'/ccg_load.php';
    }
