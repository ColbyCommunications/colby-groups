...
/* modify the authors select menu based on group membership */
add_filter( 'wp_dropdown_users_args', array( 'CCG_Dashboard', 'colbygroups_dropdown_users' ), 10, 2 );
...
/* handle switch_to_user hook for the User Switching plugin */
add_action( 'switch_to_user', array( 'CCG_Capabilities', 'ccg_switch_to_user' ) );

/* handle switch_back_user hook for the User Switching plugin */
